...
def loopThroughLayers(requisites, operators):
	...
	#more layers
		...
		for requisite in requisitesSplit:
			if requisite not in operators:
				...
				nextLayer = loopThroughLayers(requisite, operators)
...
def parseRequisites(requisiteString, operators):
	...
	finalRequisites = loopThroughLayers(requisiteString, operators)
	
	print("After seperating by operators: " + str(finalRequisites) + "\n")
	finalRequisites = splitByCommas(finalRequisites)
		
	return finalRequisites

for requisiteString in testRequisites:
	print(f"\nStart: {requisiteString}\n")
	print(f"\nFinal: {parseRequisites(requisiteString, operators)}\n")